...
func (f *Formatter) lineTitleWithLinkIfNeeded(css map[chroma.TokenType]string, lineDigits, line int) string {
	...
	return fmt.Sprintf("<a href=\"#%s\">%s</a>", f.lineID(line), title)
}
...
func convertTheme(cls string) string {
	switch cls {

	case "bg":
		return "dark:text-[#ffffff] bg-[#1f1f24]"
	case "chroma":
		return "dark:text-[#ffffff] bg-[#1f1f24]"
	case "err":
		return "dark:text-[#FF5370] text-[#000000]"
	case "lntd":
		return "align-top"
	case "lntable":
		return ""
	case "hl":
		return "dark:bg-[#353539] bg-[#e5e5e5]"
	case "lnt":
		return "whitespace-pre select-none mr-1.5 px-1.5 text-[#7f7f7f]"
	case "ln":
		return "whitespace-pre select-none mr-1.5 px-1.5 dark:text-slate-400 text-slate-700"
	case "line":
		return "flex"
	case "n":
	...
	case "kc":
		return "dark:text-[#89DDFF] text-[#a90d91]"
	case "kd":
		return "dark:text-[#BB80B3] text-[#a90d91]"
	case "kn":
		return "dark:text-[#89DDFF] text-[#a90d91]"
	...
	case "sa":
		return "dark:text-[#BB80B3] text-[#c41a16]"
	case "sb":
		return "dark:text-[#C3E88D] text-[#c41a16]"
	case "sc":
		return "dark:text-[#C3E88D] text-[#2300ce]"
	case "dl":
		return "dark:text-[#EEFFFF] text-[#c41a16]"
	case "sd":
		return "dark:text-[#546E7A] text-[#c41a16] italic"
	case "s2":
		return "dark:text-[#C3E88D] text-[#c41a16]"
	case "se":
		return "dark:text-[#EEFFFF] text-[#c41a16]"
	...
	case "sx":
		return "dark:text-[#C3E88D] text-[#c41a16]"
	case "sr":
		return "dark:text-[#89DDFF] text-[#c41a16]"
	case "s1":
		return "dark:text-[#C3E88D] text-[#c41a16]"
	case "ss":
		return "dark:text-[#89DDFF] text-[#c41a16]"
	case "m":
		return "dark:text-[#F78C6C] text-[#1c01ce]"
	...
	case "mo":
		return "dark:text-[#F78C6C] text-[#1c01ce]"
	case "c":
		return "dark:text-[#546E7A] text-[#177500]"
	case "ch":
		return "dark:text-[#546E7A] text-[#177500]"
	case "cm":
		return "dark:text-[#546E7A] text-[#177500]"
	case "c1":
		return "dark:text-[#546E7A] text-[#177500]"
	case "cs":
		return "dark:text-[#546E7A] text-[#177500] italic"
	case "cp":
	...
	case "o":
		return "dark:text-[#89DDFF] text-[#000000]"
	case "g":
		return "class='dark:text-[#EEFFFF]"
	case "l":
		return "dark:text-[#C3E88D] text-[#1C01CE]"
	default:
		return cls
	}
}
...
func (f *Formatter) styleAttr(styles map[chroma.TokenType]string, tt chroma.TokenType, extraCSS ...string) string {
	if f.Classes {
		...
		// themeClass := "light_" + cls + " dark:dark_" + cls
		//themeClass := convertTheme(cls)
		themeClass := cls
		return fmt.Sprintf(` class="%s"`, themeClass)
	}
