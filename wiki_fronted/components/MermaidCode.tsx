...
import { MearmaidPara } from "@/types/interface";
const flowchart = {
  htmlLabels: true,
  curve: "basis",
  useMaxWidth: true,
...
function MermaidCode({ graphDefinition }: MearmaidPara) {
  ...
  return graphDefinition ? (
    <div className="flex items-center justify-center">
      ...
      />
      <div className="hidden cl">{graphDefinition}</div>{" "}
      <div
        className="grow block dark:hidden"
