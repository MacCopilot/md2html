...
export default function WikiInfo(props: WikiInfoProps) {
  return (
    <div className="flex-auto sticky z-30 inset-0 top-[5rem] px-8 xl:px-12  overflow-y-auto  scrollbar-thin scrollbar-thumb-rounded-md scrollbar-track-rounded-md  bg-white dark:bg-slate-900">
